...
@section('title', ___('Coupons'))
@section('header_buttons')
    <a href="#" data-url="{{ route('admin.coupons.create') }}" data-toggle="slidePanel" class="btn btn-primary ms-2"><i class="icon-feather-plus me-2"></i> {{ ___('Add New') }}</a>
@endsection
@section('content')
