            ...
            <div class="mb-3 form-group">
                ...
                @foreach ($admin_languages as $language)
                    <div class="translate-fields translate-fields-{{ $language->code }}" style="display: none">
                        <input type="text" class="form-control" name="translations[{{ $language->code }}][title]" placeholder="{{ ___('Enter plan option title') }}" value="{{ !empty($planoption->translations->{$language->code}->title)
