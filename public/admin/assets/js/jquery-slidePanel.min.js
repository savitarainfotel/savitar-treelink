!function (a, b, c, d) {
    ...
    o.options = {
        ...
        initialize: function (a) {
            ...
            if (this.options.useCssTransforms && t.transform) {
                if (b = h(this.$panel.css('transform')), !b)return 0;
    ...
    var v = {
        prepareTransition: function (b, c, d, e, f) {
            var g = [];
            c && g.push(c), d && (a.isNumeric(d) && (d += "ms"), g.push(d)), g.push(e ? e : this.easing.css), f && g.push(f), b.css('transition', g.join(" "))
        }, "do": function (b, d, f) {
            w.enter("animating");
            ...
            if (b.options.useCssTransitions && t.transition)setTimeout(function () {
                ...
                a.isFunction(f) && f(), b.$panel.css('transition', ""), w.leave("animating")
            }), setTimeout(function () {
                b.setPosition(d)
            }, 20); else {
