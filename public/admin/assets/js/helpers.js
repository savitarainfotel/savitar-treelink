        ...
        var d = {
            ...
            _redrawLayoutMenu: function () {
                ...
                if (e && e.querySelector(".menu")) {
                    var t = e.querySelector(".menu-inner"), n = t.scrollTop, i = document.documentElement.scrollTop;
            ...
            scrollPageTo: function (e) {
                ...
                var i = n.scrollTop, o = e - i, r = +new Date;
                !function s() {
            ...
            setContentLayout: function () {
                ...
                setTimeout((function () {
                    var n, i = document.querySelector(".content-wrapper > div"),
                        ...
                        d = document.querySelector(".menu-vertical"), f = !1;
...
(function ($) {
    ...
    $("#layout-menu li.menu-item[data-page='" + page + "']").addClass('active');
    if (QuickMenu.subpage !== undefined) {
        $("#layout-menu li.menu-item[data-page='" + page + "']").addClass('open');
        $("#layout-menu li.menu-item[data-page='" + page + "'] .menu-sub li.menu-item[data-page='" + QuickMenu.subpage + "']").addClass('active');
    }
})(jQuery);
